...
Namespace HowToAddAnalyzeAction.Win
    Partial Public Class HowToAddAnalyzeActionWindowsFormsApplication
        ...
        Private Sub HowToAddAnalyzeActionWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
